...
/*   Updated: 2022/05/05 22:17:20 by ydumaine         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_sleep(t_data *data, int id)
{
	...
	printf("\n%d %d is sleeping", time_diff(&data->start, &start), id);
...
int	ft_eat(t_data *data, int id, int *eat_number)
{
	...
	gettimeofday(&end, NULL);
	printf("\n%d %d is eating", time_diff(&data->start, &start), id);
...
int	ft_think(t_data *data, int id)
{
	...
	gettimeofday(&start, NULL);
	printf("\n%d %d is thinking", time_diff(&data->start, &start), id);
	return (EAT);
}
